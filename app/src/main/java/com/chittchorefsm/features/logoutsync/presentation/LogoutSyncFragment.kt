package com.chittchorefsm.features.logoutsync.presentation
...
import com.chittchorefsm.app.AppDatabase
...
import com.chittchorefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.chittchorefsm.features.addshop.api.AddShopRepositoryProvider
import com.chittchorefsm.features.billing.api.AddBillingRepoProvider
import com.chittchorefsm.features.billing.model.AddBillingInputParamsModel
...
import com.chittchorefsm.features.dashboard.presentation.ReasonDialog
...
import com.chittchorefsm.features.document.model.AddEditDocumentInputParams
import com.chittchorefsm.features.document.model.DocumentAttachmentModel
...
import com.chittchorefsm.features.location.model.*
...
import com.chittchorefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.chittchorefsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.chittchorefsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.chittchorefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.chittchorefsm.features.orderhistory.model.*
...
import com.chittchorefsm.features.quotation.model.AddQuotInputModel
import com.chittchorefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.chittchorefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.chittchorefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.chittchorefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.chittchorefsm.features.timesheet.model.AddTimeSheetInputModel
import com.chittchorefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.chittchorefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.chittchorefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.chittchorefsm.mappackage.SendBrod
import com.chittchorefsm.widgets.AppCustomTextView
import com.chittchorefsm.MonitorService
import com.chittchorefsm.features.addshop.model.*
import com.chittchorefsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.chittchorefsm.features.login.api.LoginRepositoryProvider
import com.chittchorefsm.features.login.model.GetConcurrentUserResponse
import com.chittchorefsm.features.returnsOrder.ReturnProductList
import com.chittchorefsm.features.returnsOrder.ReturnRequest
import com.chittchorefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xchittchorefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xchittchorefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xchittchorefsmlogsample/log.zip").path);
